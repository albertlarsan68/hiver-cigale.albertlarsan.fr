        ...
        <a style="cursor: initial;"><svg style="max-width: 100%;height: auto;" width="984" height="984" viewBox="0 0 984 984">
                ...
                <g fill="#26a269">
                    <g transform="translate(240,48) scale(4.12)">
                        <path d="M6,5.5H3C1.6,5.5,0.5,4.4,0.5,3v0c0-1.4,1.1-2.5,2.5-2.5h3V5.5z"></path>
                    </g>
                    <g transform="translate(264,48) scale(4.12)">
                        <rect y="0.5" width="6" height="5"></rect>
                    </g>
                    <g transform="translate(288,48) scale(4.12)">
                        <path d="M3,5.5H0v-5h3c1.4,0,2.5,1.1,2.5,2.5v0C5.5,4.4,4.4,5.5,3,5.5z"></path>
                    </g>
                ...
                <g>
                    <g transform="translate(48,48)" fill="#e5a50a">
                    ...
                    <g transform="translate(768,48)" fill="#e5a50a">
                        <g transform="scale(12) rotate(90 7 7)">
                            <path d="M0,0l0,7c0,3.9,3.1,7,7,7h7V7c0-3.9-3.1-7-7-7H0z M7,12L7,12c-2.8,0-5-2.2-5-5v0c0-2.8,2.2-5,5-5h0c2.8,0,5,2.2,5,5v0 C12,9.8,9.8,12,7,12z"></path>
                        </g>
                    </g>
                    <g transform="translate(48,768)" fill="#e5a50a">
                        <g transform="scale(12) rotate(-90 7 7)">
                            <path d="M0,0l0,7c0,3.9,3.1,7,7,7h7V7c0-3.9-3.1-7-7-7H0z M7,12L7,12c-2.8,0-5-2.2-5-5v0c0-2.8,2.2-5,5-5h0c2.8,0,5,2.2,5,5v0 C12,9.8,9.8,12,7,12z"></path>
                        </g>
                    </g>
